package musician.kuet.musta.db;
...
import musician.kuet.musta.Utils.PrefsUtility;
...
public class AlbumLoader {
    ...
    public static Cursor makeAlbumCursor(Context context, String selection, String[] paramArrayOfString) {
        final String albumSortOrder = PrefsUtility.getInstance(context).getAlbumSortOrder();
