package musician.kuet.musta.Utils;
...
public final class PrefsUtility {
    ...
    private static PrefsUtility sInstance;

    private static SharedPreferences mPreferences;
    private static Context context;
    private ConnectivityManager connManager = null;

    public PrefsUtility(final Context context) {
        PrefsUtility.context = context;
        mPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    }

    public static PrefsUtility getInstance(final Context context) {
        if (sInstance == null) {
            sInstance = new PrefsUtility(context.getApplicationContext());
        }
        return sInstance;
    }
